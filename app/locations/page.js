export default function page() {
  return (
    <div>
      ...
      <meta
        name="description"
        content="Making homes beautiful one state at a time."
      />
      <link rel="icon" href="favicon.ico" />
      <meta property="og:title" />
      <meta property="og:description" />
      <meta
        property="og:/locations/images/image"
        content="/locations/images/images/SEODefaultLogo.png"
      />
      <meta property="og:url" content="https://freemodel.com/locations" />
              ...
              <div className="items-center px-4 max-w-screen-xl mx-auto lg:flex lg:px-8">
                <div className="flex items-center justify-between py-3 lg:py-5 lg:block">
                  <a href="/">
                    <img
                      ...
                      srcSet="/locations/images/image_6 1x, /locations/images/image 2x"
                      src="/locations/images/image"
                    />
                  </a>
                ...
                <div className="flex-1 pb-3 mt-8 lg:block lg:pb-0 lg:mt-0 hidden">
                  <ul className="justify-end items-center space-y-6 lg:flex lg:space-x-6 lg:space-y-0">
                    ...
                    <li className="text-black hover:text-FM-orange lg:text-base">
                      <a href="/locations" className="text-FM-orange">
                        Locations
                      </a>
                    </li>
                    <li className="text-black hover:text-FM-orange lg:text-base">
            ...
            <main>
              <div className="relative">
                <img
                  ...
                  sizes="100vw"
                  srcSet="/locations/images/image_8 640w, /locations/images/image_11 750w, /locations/images/image_9 828w, /locations/images/image_7 1080w, /locations/images/image_10 1200w, /locations/images/image_14 1920w, /locations/images/image_15 2048w, /locations/images/image_5 3840w"
                  src="/locations/images/image_5"
                />
                <div
              ...
              <div className="bg-gray-800">
                <div className="text-center w-full mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 z-20">
                  <h2 className="text-3xl leading-[3rem] font-extrabold text-white mx-auto sm:text-[38px] sm:max-w-5xl">
                    Making homes beautiful one state at a time.
                  </h2>
                </div>
              </div>
            </main>
                ...
                >
                  <div className="relative h-52 md:h-[20vw]">
                    <img
                      ...
                      sizes="100vw"
                      srcSet="/locations/images/image_18 640w, /locations/images/image_12 750w, /locations/images/image_36 828w, /locations/images/image_35 1080w, /locations/images/image_16 1200w, /locations/images/image_27 1920w, /locations/images/image_26 2048w, /locations/images/image_2 3840w"
                      src="/locations/images/image_2"
                    />
                  </div>
                  <div className="py-4">
                    <h3 className="text-3xl text-FM-orange">Florida</h3>
                  </div>
                </a>
              </div>
              <div className="w-full">
                ...
                >
                  <div className="relative h-52 md:h-[20vw]">
                    <img
                      ...
                      sizes="100vw"
                      srcSet="/locations/images/image_13 640w, /locations/images/image_25 750w, /locations/images/image_20 828w, /locations/images/image_21 1080w, /locations/images/image_32 1200w, /locations/images/image_22 1920w, /locations/images/image_19 2048w, /locations/images/image_3 3840w"
                      src="/locations/images/image_3"
                    />
                  </div>
                  <div className="py-4">
                    <h3 className="text-3xl text-FM-orange">
                      Northern California
                    </h3>
                  </div>
                </a>
                ...
                >
                  <div className="relative h-52 md:h-[20vw]">
                    <img
                      ...
                      sizes="100vw"
                      srcSet="/locations/images/image_17 640w, /locations/images/image_23 750w, /locations/images/image_30 828w, /locations/images/image_24 1080w, /locations/images/image_31 1200w, /locations/images/image_28 1920w, /locations/images/image_33 2048w, /locations/images/image_1 3840w"
                      src="/locations/images/image_1"
                    />
                  </div>
                  <div className="py-4">
                    <h3 className="text-3xl text-FM-orange">
                ...
                >
                  <div className="relative h-52 md:h-[20vw]">
                    <img
                      ...
                      sizes="100vw"
                      srcSet="/locations/images/image_41 640w, /locations/images/image_34 750w, /locations/images/image_37 828w, /locations/images/image_39 1080w, /locations/images/image_29 1200w, /locations/images/image_40 1920w, /locations/images/image_38 2048w, /locations/images/image_4 3840w"
                      src="/locations/images/image_4"
                    />
                  </div>
                  <div className="py-4">
                    <h3 className="text-3xl text-FM-orange">Texas</h3>
                  </div>
                </a>
              </div>
            </div>
                  ...
                  <div className="sm:col-span-2">
                    ...
                    >
                      <span className="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase">
                        <img
                          src="/locations/images/153835bd18da2abd5208f200698a8de5006f9c3c-500x92.png"
                          alt="Company Logo"
                          className="w-48"
                        />
                      </span>
