...
export default function page() {
  ...
  return (
    <div>
      ...
      />
      <meta
        property="og:/projects/images/image"
        content="/projects/images/images/74696090ca84342beca88f406f9d523af6d7eedd-592x492.png"
      />
              ...
              <div className="items-center px-4 max-w-screen-xl mx-auto lg:flex lg:px-8">
                <div className="flex items-center justify-between py-3 lg:py-5 lg:block">
                  <a href="/">
                    <img
                      ...
                      srcSet="/projects/images/image_10 1x, /projects/images/image 2x"
                ...
                <div className="flex-1 pb-3 mt-8 lg:block lg:pb-0 lg:mt-0 hidden">
                  <ul className="justify-end items-center space-y-6 lg:flex lg:space-x-6 lg:space-y-0">
                    ...
                    <li className="text-black hover:text-FM-orange lg:text-base">
                      <a href="/for-homeowners">For Homeowners</a>
                    </li>
                    <li className="text-black hover:text-FM-orange lg:text-base">
                      <a href="/projects" className="text-FM-orange">
                        Projects
                      </a>
                    </li>
                    <li className="text-black hover:text-FM-orange lg:text-base">
            ...
            <main>
              <div className="relative">
                <img
                  ...
                  sizes="100vw"
                  srcSet="/projects/images/image_7 640w, /projects/images/image_7 750w, /projects/images/image_7 828w, /projects/images/image_7 1080w, /projects/images/image_27 1200w, /projects/images/image_15 1920w, /projects/images/image_16 2048w, /projects/images/image_7 3840w"
                  src="/projects/images/image_7"
                />
                <div
                  ...
                  <div className="flex gap-x-10 flex-row">
                    <div className=" inset-0 object-contain">
                      <img
                        ...
                        srcSet="/projects/images/image_9 1x, /projects/images/image_1 2x"
                        src="/projects/images/image_1"
                      />
                    </div>
                  ...
                  <div className="flex gap-x-10 flex-row-reverse">
                    <div className=" inset-0 object-contain">
                      <img
                        ...
                        className="w-16 h-full object-contain"
                        style={{ color: "transparent" }}
                        srcSet="/projects/images/image_11 1x, /projects/images/image_2 2x"
                        src="/projects/images/image_2"
                      />
                    </div>
                    <div className="flex items-center justify-center">
                      <h2 className="text-3xl font-bold text-white underline underline-offset-4 decoration-1">
                  ...
                  <div className="flex gap-x-10 flex-row">
                    <div className=" inset-0 object-contain">
                      <img
                        ...
                        className="w-16 h-full object-contain"
                        style={{ color: "transparent" }}
                        srcSet="/projects/images/image_19 1x, /projects/images/image_3 2x"
                        src="/projects/images/image_3"
                      />
                    </div>
                    <div className="flex items-center justify-center">
                      <h2 className="text-3xl font-bold text-white underline underline-offset-4 decoration-1">
                ...
                <div className="grid gap-16 row-gap-10 lg:grid-cols-2">
                  <div>
                    <img
                      ...
                      style={{ color: "transparent" }}
                      srcSet="/projects/images/image_12 1x, /projects/images/image_6 2x"
                      src="/projects/images/image_6"
                    />
                  </div>
                            ...
                            <div className="relative h-72 w-full object-cover">
                              <img
                                ...
                                style={{
                                  ...
                                  backgroundImage:
                                    "url(data:image/png;base64,iVBORw0KGgoAAAANSUhEUgAAABQAAAAUCAYAAACNiR0)", // Düzgün URL formatı
                                }}
                                sizes="(max-width: 640px) 100vw, (max-width: 768px) 90vw, (max-width: 1024px) 30vw, 26rem"
                                srcSet="/projects/images/image_13 256w, /projects/images/image_17 384w, /projects/images/image_47 640w, /projects/images/image_28 750w, /projects/images/image_30 828w, /projects/images/image_41 1080w, /projects/images/image_42 1200w, /projects/images/image_24 1920w, /projects/images/image_31 2048w, /projects/images/image_8 3840w"
                                src="/projects/images/image_8"
                              />
                            </div>
                          ...
                          >
                            <div className="relative h-72 w-full object-cover">
                              <img
                                ...
                                sizes="(max-width: 640px) 100vw, (max-width: 768px) 90vw, (max-width: 1024px) 30vw, 26rem"
                                srcSet="/projects/images/image_38 256w, /projects/images/image_18 384w, /projects/images/image_22 640w, /projects/images/image_21 750w, /projects/images/image_29 828w, /projects/images/image_35 1080w, /projects/images/image_36 1200w, /projects/images/image_33 1920w, /projects/images/image_43 2048w, /projects/images/image_5 3840w"
                                src="/projects/images/image_5"
                              />
                            </div>
                          ...
                          >
                            <div className="relative h-72 w-full object-cover">
                              <img
                                ...
                                sizes="(max-width: 640px) 100vw, (max-width: 768px) 90vw, (max-width: 1024px) 30vw, 26rem"
                                srcSet="/projects/images/image_23 256w, /projects/images/image_34 384w, /projects/images/image_25 640w, /projects/images/image_32 750w, /projects/images/image_40 828w, /projects/images/image_39 1080w, /projects/images/image_44 1200w, /projects/images/image_46 1920w, /projects/images/image_45 2048w, /projects/images/image_4 3840w"
                                src="/projects/images/image_4"
                              />
                            </div>
                  ...
                  <div className="sm:col-span-2">
                    ...
                    >
                      <span className="ml-2 text-xl font-bold tracking-wide text-gray-800 uppercase">
                        <img
                          src="/projects/images/153835bd18da2abd5208f200698a8de5006f9c3c-500x92.png"
                          alt="Company Logo"
                          className="w-48"
                        />
                      </span>
